...
const styles = StyleSheet.create({
  ...
  username: { fontSize: 20, fontWeight: '700', color: theme.colors.textPrimary },
  ...
  followBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 10, borderRadius: theme.radius.md, backgroundColor: theme.colors.accent },
  followingBtn: { backgroundColor: theme.colors.bgInput },
  followLoadingBtn: { opacity: 0.7 },
  followBtnText: { fontSize: 14, fontWeight: '600', color: '#fff' },
  followingBtnText: { color: theme.colors.textPrimary },
  iconBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: theme.colors.bgInput, alignItems: 'center', justifyContent: 'center', marginLeft: 8 },
  ...
  sectionLabel: { fontSize: 15, fontWeight: '600', color: theme.colors.textPrimary, marginBottom: 8 },
  skillsContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: 6 },
  skillTag: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: theme.radius.sm, backgroundColor: theme.colors.bgInput },
  skillText: { fontSize: 13, color: theme.colors.textPrimary },
