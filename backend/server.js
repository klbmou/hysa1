...
function contentSecurityPolicy(req, nonce) {
  ...
  const directives = [
    ...
    "media-src 'self' blob: https://res.cloudinary.com https://*.googleusercontent.com https://lh3.googleusercontent.com",
    `connect-src 'self' https://res.cloudinary.com https://accounts.google.com https://fonts.googleapis.com https://fonts.gstatic.com https://*.googleusercontent.com https://lh3.googleusercontent.com wss: ${websocketSelf.join(" ")}`.trim(),
